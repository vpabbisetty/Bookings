...
$(selector).datepick({minDate: 0, maxDate: '+1m +1w'}) */
	$.JQPlugin.createPlugin({
		...
		defaultRenderer: {
			...
			'<div class="period-select"><input type="text" id="addAmount" value="" size="4"><select id="addPeriod"><option value="d">Days (d)</option><option value="w">Weeks (w)</option>'+
				'<option value="m">Months (m)</option></select></div>'+
