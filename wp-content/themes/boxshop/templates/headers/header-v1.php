...
<header class="ts-header <?php echo esc_attr(implode(' ', $header_classes)); ?>">
	<div class="header-container">
		<div class="header-sticky header-template  header-v1 <?php echo esc_attr(implode(' ', $extra_class)); ?>">
			<div class="container">
				<div class="header-top ">
					...
					<div class="header-right">
						...
						<div class="top-right">
							...
							<div class="shopping-cart-wrapper cart-mobile visible-phone"><?php echo boxshop_tiny_cart(); ?></div>
							<?php endif; ?>
						...
						<div class="logo-wrapper logo-vetical-ipad"><?php echo boxshop_theme_logo(); ?></div>						
				...
				<div class="header-bottom">
					...
					<div class="header-right">
						...
						<?php if( $boxshop_theme_options['ts_enable_search'] ): ?>
							<div class="search-wrapper"><?php boxshop_get_search_form_by_category(); ?></div>
						<?php endif; ?>
