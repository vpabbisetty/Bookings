<div class="wrap" id="of_container">
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="info_bar">
			...
			<img style="display:none" src="<?php echo esc_url(ADMIN_DIR); ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="<?php esc_attr_e('Loading', 'boxshop'); ?>" />
		...
		<div id="ts-footer-theme-options-sticky">
			<div id="ts-footer-theme-options" class="save_bar"> 
				...
				<img style="display:none" src="<?php echo esc_url(ADMIN_DIR); ?>assets/images/loading-bottom.gif" class="ajax-reset-loading-img ajax-loading-img-bottom" alt="<?php esc_attr_e('Loading', 'boxshop'); ?>" />
...
<!-- Ads banner -->
<?php $ads_theme_url = 'https://1.envato.market/LqOqj'; ?>
<div id="ts-ads-banner-theme-options" class="hidden">
	<a href="<?php echo esc_url($ads_theme_url) ?>" target="_blank">
		<img src="<?php echo esc_url(ADMIN_DIR); ?>assets/images/ads-theme-banner.jpg" alt="<?php esc_attr_e('Banner', 'boxshop'); ?>" />
	</a>
</div>