...
if( is_admin() && isset( $_GET['activated'] ) && $pagenow == "themes.php" ){
	add_action('admin_head', 'boxshop_of_option_setup');
}
add_action('admin_head', 'boxshop_optionsframework_admin_message');
add_action('admin_init', 'boxshop_optionsframework_admin_init');
add_action('admin_menu', 'boxshop_optionsframework_add_admin');
 ...
 * @since 1.0.0
 */
add_action('wp_ajax_boxshop_of_ajax_post_action', 'boxshop_of_ajax_callback');
